...
const (
	...
	DefaultFireflyLoginAPI = "https://api.firefly.ai"
)
...
// between the different data collectors (implementing the collector.DataCollector
// interface).
type Config struct {
	...
	// Namespace is the Kubernetes namespace we're collecting data from (if empty,
